package ru.epam.jonline.module3.work_with_patterns.pattern_task1.service;
...
//    public int countCharInLexeme(String sentence, char ch) {
//        int count = 0;
//        for (int i = 0; i < sentence.length(); i++) {
//            if (sentence.charAt(i) == ch) count++;
//        }
//        return count;
//    }
